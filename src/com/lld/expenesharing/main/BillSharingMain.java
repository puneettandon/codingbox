package com.lld.expenesharing.main;
...
import com.lld.expenesharing.main.service.ExpenseService;
import com.lld.expenesharing.main.service.UserService;
...
public class BillSharingMain {
    ...
    public static void main(String[] args) throws ContributionExceededException, InvalidExpenseState, ExpenseSettledException {
        ...
        Set<User> users = expense.getExpenseGroup().getGroupMemebers();
        for(User user : users){
